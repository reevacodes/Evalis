...
def parse():
    with open('raw_mst_mcq.txt', 'r', encoding='utf-8') as f:
        text = f.read()

    mcqs = []
    
    current_topic = "Unit 1: Introduction to Programming"
    ...
    with open('mst_payload_pretty.json', 'w', encoding='utf-8') as f:
