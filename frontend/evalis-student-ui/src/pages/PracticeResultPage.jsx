  ...
  return (
    <div className="min-h-screen bg-[#0A0A0E] text-slate-800 dark:text-slate-200 p-4 md:p-8 font-sans selection:bg-indigo-500/30">
      <div className="max-w-[1400px] mx-auto space-y-6">
        ...
        <div className="bg-gray-50 dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-3xl p-6 md:p-8 flex flex-col lg:flex-row items-center justify-between gap-6 shadow-2xl relative overflow-hidden">
          ...
          <div className="flex flex-col sm:flex-row items-center text-center sm:text-left gap-6 z-10 w-full lg:w-auto">
            ...
            <div>
               <h1 className="text-3xl font-extrabold text-slate-900 dark:text-white mb-3 tracking-tight">{headerTitle}</h1>
          ...
          <div className="flex flex-wrap sm:flex-nowrap justify-center gap-4 z-10 w-full lg:w-auto">
            <div className="bg-white dark:bg-slate-950/50 border border-gray-200 dark:border-slate-800 rounded-2xl p-4 flex items-center gap-4 min-w-[150px] shadow-inner">
               ...
               <div>
                  ...
                  <p className="text-xl font-black text-slate-900 dark:text-white">{formatTime(analytics.time_spent_total)}</p>
               </div>
            </div>
            <div className="bg-white dark:bg-slate-950/50 border border-gray-200 dark:border-slate-800 rounded-2xl p-4 flex items-center gap-4 min-w-[150px] shadow-inner">
               ...
               <div>
                  ...
                  <p className="text-xl font-black text-slate-900 dark:text-white">{analytics.accuracy}%</p>
               </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-8 space-y-6">
             ...
             {/* TREND CHART */}
             <div className="bg-gray-50 dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-3xl p-6 md:p-8 shadow-lg">
                <div className="flex justify-between items-center mb-6">
                   <h2 className="text-xl font-bold text-slate-900 dark:text-white flex items-center gap-2">
                      <BarChart2 className="w-5 h-5 text-indigo-400" /> Performance Trend
                   </h2>
                   <div className="flex gap-2">
                      <span className="text-xs font-bold text-slate-500 bg-white dark:bg-slate-800 px-3 py-1 rounded-full">All Time</span>
                   </div>
                </div>
             ...
             <div className="bg-gray-50 dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-3xl p-6 md:p-8 shadow-lg">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                   {/* MCQ Section */}
                   <div className="bg-white dark:bg-slate-950 border border-gray-200 dark:border-slate-800 rounded-2xl p-5 flex flex-col justify-between">
                      ...
                      <div className="space-y-3">
                         <div className="flex justify-between items-center text-sm">
                            ...
                            <span className="font-bold text-slate-700 dark:text-slate-300">{analytics.attempted_mcqs} / {analytics.total_mcqs}</span>
                         </div>
                         <div className="flex justify-between items-center text-sm">
                         ...
                         <div className="flex justify-between items-center text-sm">
                            ...
                            <span className="font-bold text-slate-700 dark:text-slate-300">{formatTime(analytics.time_spent_mcq)}</span>
                         </div>
                      </div>
                   </div>
                   ...
                   <div className="bg-white dark:bg-slate-950 border border-gray-200 dark:border-slate-800 rounded-2xl p-5 flex flex-col justify-between">
                      <div className="flex justify-between items-start mb-4">
                         <span className="font-bold text-lg text-slate-900 dark:text-white">Coding Assessment</span>
                      ...
                      <div className="space-y-3">
                         <div className="flex justify-between items-center text-sm">
                            ...
                            <span className="font-bold text-slate-700 dark:text-slate-300">Background Queue</span>
                         </div>
                         <div className="flex justify-between items-center text-sm">
                            <span className="text-slate-500 font-medium">Time Elapsed</span>
                            <span className="font-bold text-slate-700 dark:text-slate-300">{formatTime(analytics.time_spent_coding)}</span>
                         </div>
                      </div>
                   </div>
                </div>
                      ...
                      return (
                         <div key={topic} className="group">
                            <div className="flex justify-between items-end mb-2">
                               <div>
                                  <span className="font-bold text-slate-900 dark:text-white text-lg block mb-1">{topic}</span>
                                  <div className="flex flex-wrap gap-2 text-xs font-medium">
                                     <span className="bg-white dark:bg-slate-800/50 text-slate-700 dark:text-slate-300 px-2 py-0.5 rounded border border-gray-300 dark:border-slate-700/50">Score: {stat.correct}</span>
                               ...
                               <div className="text-right shrink-0 ml-4">
                                  ...
                                  <span className="font-black text-slate-900 dark:text-white text-lg leading-none block">{rate}% <span className="text-xs text-slate-500 font-medium">Acc</span></span>
                               </div>
                            </div>
                            <div className="w-full h-2.5 bg-white dark:bg-slate-950 rounded-full overflow-hidden border border-gray-200 dark:border-slate-800/50 mt-3">
                               <div 
          ...
          <div className="lg:col-span-4 space-y-6">
             <div className="bg-gradient-to-b from-slate-900 to-slate-900 border border-gray-200 dark:border-slate-800 rounded-3xl p-6 md:p-8 h-full shadow-2xl relative overflow-hidden flex flex-col">
                ...
                <div className="relative z-10">
                   ...
                   <p className="text-sm text-slate-500 dark:text-slate-400 mb-8 font-medium">Targeted recommendations based on your performance.</p>

                   {analytics.weak_topics && analytics.weak_topics.length > 0 ? (
                      <div className="flex-1 flex flex-col gap-4">
                         {analytics.weak_topics.map((topic, idx) => (
                            <div key={topic} className="bg-white dark:bg-slate-950 border border-gray-200 dark:border-slate-800 rounded-2xl p-4 flex gap-4 items-start hover:border-gray-300 dark:border-slate-700 hover:shadow-lg transition-all group">
                               <div className="mt-0.5 w-6 h-6 rounded-full bg-rose-500/20 text-rose-400 flex items-center justify-center font-bold text-xs shrink-0 group-hover:bg-rose-500 group-hover:text-slate-900 dark:text-white transition-colors">
                                  {idx + 1}
                               </div>
                      ...
                      <div className="flex-1 flex flex-col items-center justify-center text-center py-10 bg-white dark:bg-slate-950 rounded-2xl border border-gray-200 dark:border-slate-800">
                         <div className="w-20 h-20 bg-emerald-500/10 rounded-full flex items-center justify-center mb-4">
                            <CheckCircle2 className="w-10 h-10 text-emerald-400" />
                         </div>
                         <h3 className="text-lg font-bold text-emerald-400 mb-1">Flawless Run</h3>
                         <p className="text-sm text-slate-500 dark:text-slate-400 font-medium">No immediate weak points detected.</p>
                      </div>
                   )}
        ...
        {coding_results && Object.keys(coding_results).length > 0 && (
           <div className="bg-gray-50 dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-3xl overflow-hidden transition-all duration-300 shadow-lg">
              <button 
                 ...
                 className="w-full p-6 md:p-8 flex items-center justify-between hover:bg-white dark:bg-slate-800/50 transition-colors"
              >
                 <div className="flex items-center gap-5">
                    ...
                    <div className="text-left">
                       <h2 className="text-xl font-bold text-slate-900 dark:text-white mb-1">Coding Execution Log</h2>
                 ...
                 <div className="text-slate-500 bg-white dark:bg-slate-950 p-2.5 rounded-full border border-gray-200 dark:border-slate-800 group-hover:text-slate-900 dark:text-white transition-colors">
